            ...
            <div class="hidden sm:flex sm:ml-6">
                ...
                <x-jet-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        @else
                            <button
                                class="my-auto flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        ...
                        <x-jet-responsive-nav-link href="{{ url('/my-community') }}" :active="request()->routeIs('community')">
                            {{ __('My Communities') }}
                        </x-jet-responsive-nav-link>

                        <x-jet-responsive-nav-link href="{{ url('/my-vehicles') }}" :active="request()->routeIs('vehicles')">
                            {{ __('My Vehicles') }}
                        </x-jet-responsive-nav-link>
