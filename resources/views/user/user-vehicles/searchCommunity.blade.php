...
<x-app-layout>
    @section('title', 'search community')
                ...
                <div class="modal-content md:max-w-md">
                    <header class="modal-header">
                        ...
                        <button type="button" class="close-modal-button focus:outline-none"
                            data-dismiss="search-community-{{ $userVehicleId }}" aria-label="Close">
                    ...
                    <form method="GET" action="{{ route('vehicles.community.search') }}">
                        ...
                        <article class="modal-body">
                            <x-text-input :input="['value' => '', 'name' => 'search', 'title' => 'Search Community']" />
                        </article>
                ...
                <div class="bg-white m-3 rounded-lg border p-6">
                    <div class="flex flex-col items-center justify-center md:text-left">
                        ...
                        <div class="flex mt-3 justify-center bg-gray-50 text-gray-600">
                            @php
                            $alreadyRegistered =
                            UserVehicleController::checkIfVehicleAlreadyRegistered($community->communityId,
                            $userVehicleId);
                            @endphp
                                                        ...
                                                        <div class="py-3 m-3 relative text-sm">
                                                            ...
                                                            <ul class="flex flex-col">
                                                                @if ($community->driverLicenseIdAccess)
                                                                    <li class="relative block py-3 px-5 text-left">-
                                                                        Driver's
                                                                        License ID </li>
                                                                @endif
                                                                @if ($community->vehicleRegNumAccess)
                                                                    <li class="relative block py-3 px-5 ">- Vehicle
                                                                        Registration
                                                                        Number </li>
                                                                @endif
        ...
        @else
            <div class="mt-3 text-center bg-gray-100 p-3">
                <p>
                    Result not found
                </p>
            </div>
